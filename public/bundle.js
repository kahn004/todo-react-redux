...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersAddTodo = __webpack_require__(180);

	var _containersAddTodo2 = _interopRequireDefault(_containersAddTodo);

	var _containersTodoList = __webpack_require__(181);

	var _containersTodoList2 = _interopRequireDefault(_containersTodoList);

	var _containersFooter = __webpack_require__(183);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'row' },
	        _react2['default'].createElement(_containersAddTodo2['default'], {
	          onAddClick: function (text) {
	            return dispatch((0, _actions.addTodo)(text));
	          } }),
	        _react2['default'].createElement(_containersTodoList2['default'], {
	          todos: visibleTodos,
	          onTodoClick: function (index) {
	            return dispatch((0, _actions.completeTodo)(index));
	          } }),
	        _react2['default'].createElement(_containersFooter2['default'], {
